...
Key learning: `signal.NotifyContext` (Go 1.16+) is the modern way to handle shutdown. It combines signal handling with context cancellation, allowing
your entire application to respond to termination signals through the same context propagation you use for timeouts and cancellation.
